namespace CarRentingSystem.Services.Cars
{
    ...
    public class CarService : ICarService
    {
        ...
        public CarService(SupercarDbContext data, IMapper mapper)
        {
            this.data = data;
        ...
        public int Create(int price, string brand, string model, string description, string imageUrl, int year, int categoryId, int dealerId)
        {
            var carData = new Car
            {
                Brand = brand,
